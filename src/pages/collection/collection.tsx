...
const Collection = () => {
    ...
    function fetchNFTs() {
        ...
        getNft('0xED5AF388653567Af2F388E6224dC7C4b3241C544', "eth", limit, currentOffset)
            .then(
                result => {
                    console.log(result)
                    setNFTsContainer({total: result.total, nfts: [...NFTsContainer.nfts, ...result]})
            ...
            <header className={styles.collectionHeader}>
                <div className={styles.bannerWrapper}>
                    <img className={styles.bannerImg}
                         src="https://lh3.googleusercontent.com/O0XkiR_Z2--OPa_RA6FhXrR16yBOgIJqSLdHTGA0-LAhyzjSYcb3WEPaCYZHeh19JIUEAUazofVKXcY2qOylWCdoeBN6IfGZLJ3I4A=h600"
                         alt=""/>
                </div>
                <div className={styles.headerContent}>
                    <div className={styles.collectionPreviewImgWrapper}>
                        <img className={styles.collectionPreviewImg}
                             src="https://lh3.googleusercontent.com/H8jOCJuQokNqGBpkBN5wk1oZwO7LM8bNnrHCaekV2nKjnCqw6UB5oaH8XyNeBDj6bA_n1mjejzhFQUP3O1NfjFLHr3FOaeHcTOOT=s130"
                             alt=""/>
                    </div>
                    <div className={styles.collectionInfo}>
                        ...
                        <p className={styles.collectionDesc}>
                            <p>
                                A brand for the metaverse. Built by the community. View the collection at
                                azuki.com/gallery.
                            </p>
                            <p>
                                ...
                                create a decentralized future. Azuki holders receive access to exclusive drops,
                                experiences, and more. Visit azuki.com for more details.
                            </p>
                            <p>
